...
rem diff _test-data\csv\ws1-all.csv  _test-data\csv\ws2-all.csv _test-data\csv\ws3-all.csv
diff _test-data\csv\ws1-region.csv  _test-data\csv\ws2-region.csv _test-data\csv\ws3-region.csv
