...
Source: install\jc-start.bat;                     DestDir: {app}\web\WEB-INF;     Flags: ignoreversion
...
Source: install\cfg\decode_strategy_186.json;     DestDir: {app}\web\WEB-INF\cfg; Flags: ignoreversion; Components: ServerComponent
Source: install\cfg\publication_lic_186_srv.json; DestDir: {app}\web\WEB-INF\cfg; Flags: ignoreversion; Components: ServerComponent
Source: install\cfg\publication_lic_186_ws.json;  DestDir: {app}\web\WEB-INF\cfg; Flags: ignoreversion; Components: ServerComponent
