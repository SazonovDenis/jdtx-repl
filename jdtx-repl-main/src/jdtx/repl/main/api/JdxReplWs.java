...
public class JdxReplWs {
    ...
    public void repairAfterBackupRestore(boolean doRepair, boolean doPrintIfNeedNoRepair) throws Exception {
        ...
        */
        ...
        // Ошибки игнорируем, т.к. все, что не исправится из каталога через repairQueByDir будет запрошено с сервера
        // ---
        ...
        // а из-за наличия во входящей очереди НАШИХ СОБСТВЕННЫХ потерянных данных - генераторы перейдут в неправильное состояние.
        ...
        if (!repairMode_EmptyBase) {
            ...
            // таблица возрастов аудита (Z_Z_AGE) также пуста (и не может быть востановлена),
