...
public class UtAuditSelector {
    ...
    public void __clearAuditData(long ageFrom, long ageTo) throws Exception {
        ...
        db.startTran();
        try {
            // удал€ем журнал измений во всех таблицах
            for (IJdxTableStruct t : struct.getTables()) {
                // »нтервал id в таблице аудита, который покрывает возраст с ageFrom по ageTo
    ...
    /**
     * ¬озвращает, на каком ID таблицы аудита закончилась реплика с возрастом age
     *
     * @param tableFrom дл€ какой таблицы
     * @param age       возраст Ѕƒ
     * @return id таблицы аудита, соответствующа€ возрасту age
     */
