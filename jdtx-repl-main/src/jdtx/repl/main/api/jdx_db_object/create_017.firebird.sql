...
CREATE generator ${args.SYS_GEN_PREFIX}que_in;

SET generator ${args.SYS_GEN_PREFIX}que_in TO 0;
...
CREATE generator ${args.SYS_GEN_PREFIX}que_in001;

SET generator ${args.SYS_GEN_PREFIX}que_in001 TO 0;
...
CREATE generator ${args.SYS_GEN_PREFIX}que_out;

SET generator ${args.SYS_GEN_PREFIX}que_out TO 0;
...
CREATE generator ${args.SYS_GEN_PREFIX}srv_que_in;

SET generator ${args.SYS_GEN_PREFIX}srv_que_in TO 0;
...
CREATE generator ${args.SYS_GEN_PREFIX}srv_que_out000;

SET generator ${args.SYS_GEN_PREFIX}srv_que_out000 TO 0;
...
CREATE generator ${args.SYS_GEN_PREFIX}srv_que_out001;

SET generator ${args.SYS_GEN_PREFIX}srv_que_out001 TO 0;
