...
public class HttpUploadFile_Test {
    ...
    public static void main(final String[] args) throws Exception {
        String url = "http://localhost/lombard.systems/repl/test_send.php";
        ...
        StringBody stringBody_guid = new StringBody("61ba238dfc94503e", ContentType.MULTIPART_FORM_DATA);
        StringBody stringBody_no = new StringBody("777", ContentType.MULTIPART_FORM_DATA);
        //
