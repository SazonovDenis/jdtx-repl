...
Для описанного сценария при любом порядке применения реплик
(сначала справочники потом зависимые или наоборот)
возникнет ситуация, когда либо в справочнике удаляем раньше времени,
либо в зависимой вставляем раньше времени.
...
??? Промежуточные узлы, если в них есть необходимость по каким-либо соображениям являются лишь _траспортными_,
...
* Консенсусное распределенное удаление.
  ...
  В данной схеме есть проблемный сценарий:
