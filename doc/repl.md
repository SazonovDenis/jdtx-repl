...
#### Сбор данных с рабочих станций и обратное распространение по всей сети

Выполняется специальным обработчиком readPublicationData,
который вводит новое понятие - общая очередь. Пока не реализуем.
